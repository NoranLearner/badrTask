...
<nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="brand-img d-inline-block" src="{{ asset('assets/back/dist/img/logo-dark.png') }}" alt="brand" />
    </a>
    <a class="navbar-brand" href="{{ URL('/') }}">
        <img class="brand-img d-inline-block" src="{{ asset('assets/back/dist/img/main-logo.png') }}" alt="brand" />
    </a>
                ...
                <div class="notifications-nicescroll-bar">
                        ...
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar avatar-sm">
                                    <img src="{{ asset('assets/back/dist/img/avatar1.jpg') }}" alt="user"
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar avatar-sm">
                                    <img src="{{ asset('assets/back/dist/img/avatar2.jpg') }}" alt="user"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body">
        ...
        <li class="nav-item dropdown dropdown-authentication">
            <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown"
                ...
                <div class="media">
                    <div class="media-img-wrap">
                        <div class="avatar">
                            <img src="{{ asset('assets/back/dist/img/avatar12.jpg') }}" alt="user"
                                class="avatar-img rounded-circle">
                        </div>
...
<div class="hk-settings-panel">
    <div class="nicescroll-bar position-relative">
        <div class="settings-panel-wrap">
            <div class="settings-panel-head">
                <img class="brand-img d-inline-block align-top" src="{{ asset('assets/back/dist/img/logo-light.png') }}"
                    alt="brand" />
            ...
            <div class="layout-img-wrap">
                <div class="row">
                    <a href="javascript:void(0);" class="col-6 mb-30 active">
                        <img class="rounded opacity-70" src="{{ asset('assets/back/dist/img/layout1.png') }}"
                            alt="layout">
                        <i class="zmdi zmdi-check"></i>
                    </a>
                    <a href="dashboard2.html" class="col-6 mb-30">
                        <img class="rounded opacity-70" src="{{ asset('assets/back/dist/img/layout2.png') }}"
                            alt="layout">
                        <i class="zmdi zmdi-check"></i>
                    </a>
                    <a href="dashboard3.html" class="col-6 mb-30">
                        <img class="rounded opacity-70" src="{{ asset('assets/back/dist/img/layout3.png') }}"
                            alt="layout">
                        <i class="zmdi zmdi-check"></i>
                    </a>
                    <a href="dashboard4.html" class="col-6 mb-30">
                        <img class="rounded opacity-70" src="{{ asset('assets/back/dist/img/layout4.png') }}"
                            alt="layout">
                        <i class="zmdi zmdi-check"></i>
                    </a>
                    <a href="dashboard5.html" class="col-6">
                        <img class="rounded opacity-70" src="{{ asset('assets/back/dist/img/layout5.png') }}"
                            alt="layout">
                        <i class="zmdi zmdi-check"></i>
                    </a>
                </div>
            ...
            <div class="button-list hk-nav-select mb-10">
                <button type="button" id="nav_light_select"
                    class="btn btn-outline-primary btn-sm btn-wth-icon icon-wthot-bg"><span class="icon-label"><i
                            class="fa fa-sun-o"></i> </span><span class="btn-text">Light
                        Mode</span></button>
                <button type="button" id="nav_dark_select"
                    class="btn btn-outline-light btn-sm btn-wth-icon icon-wthot-bg"><span class="icon-label"><i
                            class="fa fa-moon-o"></i> </span><span class="btn-text">Dark
                        Mode</span></button>
            </div>
            <hr>
    ...
    <img class="d-none" src="{{ asset('assets/back/dist/img/logo-light.png') }}" alt="brand" />
    <img class="d-none" src="{{ asset('assets/back/dist/img/logo-dark.png') }}" alt="brand" />
</div>
<!-- /Setting Panel -->
